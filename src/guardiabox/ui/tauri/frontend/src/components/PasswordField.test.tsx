...
describe("PasswordField", () => {
  it("renders with placeholder + masked input", () => {
    render(<PasswordField value="" onChange={() => {}} placeholder="Mot de passe" />);
  ...
  it("shows the strength label live", () => {
    render(<PasswordField value="Aa1!Aa1!Aa1!Aa1!Aa1!" onChange={() => {}} />);
  ...
  it("hides the strength bar when showStrength is false", () => {
    render(
      <PasswordField value="abc" onChange={() => {}} showStrength={false} />,
    );
