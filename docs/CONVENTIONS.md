...
Inheritance is reserved for genuine _is-a_ relationships (e.g. SQLAlchemy
...
- Document _why_, not _what_: the code already says what.
...
Ask: _"if a contributor reads this in six months without context, will they
guess what I meant?"_ — if no, refactor or document.
